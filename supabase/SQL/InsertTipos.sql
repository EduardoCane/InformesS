...
(
  ...
  '[
    ...
    {"id":"normal-images","label":"Imagenes","type":"image","options":[],"required":false,"isResultField":false,"repeatableGroup":"activity-block","imageLayout":"rows"},
...
(
  ...
  '[
    ...
    {"id":"completo-images","label":"Fotos","type":"image","options":[],"required":false,"isResultField":false,"repeatableGroup":"activity-block","imageLayout":"grid3x3"}
  ]'::jsonb
);